...
Shader "Custom/NormalMapWorldSapceShader"
{
    Properties{
    ...
    SubShader {
        Pass {
            ...
            v2f vert(a2v v){
                ...
                fixed3 worldTangent = mul((float3x3)unity_ObjectToWorld, v.tangent);
            ...
            fixed4 frag(v2f i) : SV_Target{
                ...
                fixed3 specular = _LightColor0.xyz * _Specular.xyz * pow(saturate(dot(bump, halfDir)), _Gloss);
